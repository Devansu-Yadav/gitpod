...
type WorkspaceInstanceStatus struct {
	...
	Repo *WorkspaceInstanceStatus_Repo `protobuf:"bytes,8,opt,name=repo,proto3" json:"repo,omitempty"`
}
...
var file_gitpod_experimental_v1_workspaces_proto_rawDesc = []byte{
	...
	0x12, 0x48, 0x0a, 0x04, 0x72, 0x65, 0x70, 0x6f, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x34,
